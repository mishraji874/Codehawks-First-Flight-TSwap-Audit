...
// @audit-info IERC20 interface contract is not used
...
contract PoolFactory {
    ...
    /*//////////////////////////////////////////////////////////////
                                 EVENTS
    //////////////////////////////////////////////////////////////*/
    // @audit-info event is missing indexed field
    ...
    constructor(address wethToken) {
        // @audit - low - lacks a zero on error
    ...
    function createPool(address tokenAddress) external returns (address) {
        ...
        // e "TSwap DAI"
        // q weird ERC20 "what if the the name type function reverts!"
        string memory liquidityTokenName = string.concat("T-Swap ", IERC20(tokenAddress).name());
        // "tsUSDC"
        // @audit - low -  this should be symbol not .name()
