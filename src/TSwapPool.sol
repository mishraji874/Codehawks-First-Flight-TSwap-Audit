...
// @audit-info different versions are used. better to use same versions ^0.8.20
...
contract TSwapPool is ERC20 {
    ...
    // @audit-info events should be indexed if there are more than 3 parameters
    event Swap(
    ...
    function deposit(
        ...
        uint256 minimumLiquidityTokensToMint,
        uint256 maximumPoolTokensToDeposit,
        // @audit - high - dealine parameter is not used
        uint64 deadline
    )
        external
        ...
        returns (uint256 liquidityTokensToMint)
    {
        if (wethToDeposit < MINIMUM_WETH_LIQUIDITY) {
            revert TSwapPool__WethDepositAmountTooLow(
                // @audit-info MINIMUM_WETH_LIQUIDITY is a constant and therefore not required
        ...
        if (totalLiquidityTokenSupply() > 0) {
            ...
            // @audit - gas - poolTokenReserves initialization and the line is not required to use in the contract
            ...
            // @audit-info - it would be beter if this was before the '_addLiquidityMintAndTransfer' call to follow CEI
    ...
    function _addLiquidityMintAndTransfer(
        ...
        // @audit - low - protocol is giving wrong return / information
        // ans - (msg.sender, wethToDeposit, poolTokensToDeposit)
        ...
        returns (uint256 outputAmount)
    {
        ...
        // @audit-info use of magic numbers should be avoid
    ...
    {
        // @audit-info use of magic number should be avoid
        // @audit - high - users are charged too much and also the swapExactOutput is one of the main swapping function
        return
    ...
    // @audit-info natspec should be there for function description
    function swapExactInput(
        ...
        // @audit-info should be marked as external
        public
        revertIfZero(inputAmount)
        revertIfDeadlinePassed(deadline)
        returns (
